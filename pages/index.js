...
//     <button onClick={async() => {await signIn();}} className="flex mx-auto mt-20 text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded text-lg">Register!</button>
//     <SignIn /> 
//   </div>
// </section>
//   );
